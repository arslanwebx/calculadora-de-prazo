...
for (const file of ["robots.txt", "sitemap.xml", ".htaccess", "_headers", "assets/logo.svg", "assets/og-image.png", "assets/app.js", "assets/contact.js", "assets/data/states.json", "assets/data/municipalities.json", "assets/data/tribunals.json", "assets/data/calculator-data-manifest.json", "contato/index.html"]) {
